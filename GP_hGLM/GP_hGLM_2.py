...
class GP_hGLM(nn.Module):
    def __init__(self, C_den, S, N, M, R):
        ...
        self.kern_var_log = nn.Parameter(torch.randn(self.S)-3 , requires_grad=True)
    ...
    def forward(self, S_e, S_i):
        ...
        F_e = all_F[:self.S//2].clone().unsqueeze(1)
        F_i = all_F[self.S//2:].clone().unsqueeze(1)
        ...
        return final_voltage, self.mean_u, all_S_u, all_cov_u, all_cov_u_inv, F_e, F_i
